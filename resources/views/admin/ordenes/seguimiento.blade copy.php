...
<div class="card-body table-responsive p-2" style="height: 600px;">
      <table id="seguimiento"  class="table  p-2 table-head-fixed text-nowrap table-hover ">
        <thead>
        <tr> 
 ...
 function fill_datatable( usuario = '', periodo = '', zona = '', estado = '', fechaini = '', fechafin = '', suscriptor = '', medidor = '', critica = '')
{
 var datatable = $('#seguimiento').DataTable({
     ...
     ajax:{
       ...
       data:    {usuario:usuario, periodo:periodo, zona:zona, estado:estado, fechaini:fechaini, fechafin:fechafin, suscriptor:suscriptor, medidor:medidor, critica:critica, _token:"{{ csrf_token() }}" },
       method: 'post'
     },
     columns: [
       {
           data:'action', name:'action', order: false, searchable: false
