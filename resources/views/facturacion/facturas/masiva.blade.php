    ...
    <div class="modern-card">
        <div class="card-header">
            ...
            <a href="{{ route('facturas.index') }}" class="btn btn-light" style="border-radius:12px;font-weight:700;">
             ...
             <a href="{{ route('facturacion.especial.index') }}" class="btn btn-primary" style="border-radius:12px;font-weight:700;background:linear-gradient(135deg,#667eea,#764ba2);border:none;">
                    <i class="fa fa-bolt"></i> Facturación Masiva Critica
                </a>
        </div>
    </div>
