...
Route::get('/brochure', function () {
    $path = resource_path('views/brochure.html');
...
Route::group(['middleware' => 'auth', 'prefix' => 'facturacion'], function () {
    ...
    Route::get('facturas/data', 'FacturaController@data')
        ->name('facturas.data');
    Route::get('facturas/kpis', 'FacturaController@kpis')
        ->name('facturas.kpis');
    Route::get('facturas/reporte-data', 'FacturaController@reporteData')
        ->name('facturas.reporte-data');
